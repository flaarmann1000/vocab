...
import { getCollections, getSettings, saveSettings } from '@/lib/storage';
import { AppSettings, VocabCollection } from '@/lib/types';
  ...
  return (
    <div className="max-w-xl mx-auto w-full px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        {saved && (
          <span className="text-sm text-green-400 transition-opacity">Saved ✓</span>
        )}
      </div>
      ...
      <section className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
        ...
        <p className="text-xs text-zinc-500 mb-4">
          These collections will be pre-selected when you start training.
        </p>
